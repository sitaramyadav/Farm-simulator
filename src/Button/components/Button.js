...
export class Button extends React.Component {
    constructor(props) {
        ...
        this.handleCloudyToggleClick = this.handleCloudyToggleClick.bind(this);
    }
    ...
    handleCloudyToggleClick() {
        this.props.onCloudyToggle();
    }
    ...
    render() {
        return (
            <div className="controls">
                ...
                <button onClick={this.handleCloudyToggleClick} className="control cloudy"> Cloudy </button>
            </div>
        )
    }
